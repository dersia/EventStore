...
namespace EventStore.Core.Tests.Index.IndexV4 {
	...
	public class when_merging_ptables_vx_to_v4 : SpecificationWithDirectoryPerTestFixture {
		...
		public override void TestFixtureSetUp() {
			...
			_tables.Add(PTable.FromMemtable(table, GetTempFilePath(), ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault, skipIndexVerify: _skipIndexVerify));
			...
			_newtable = PTable.MergeTo(_tables, _newtableFile, (streamId, hash) => hash + 1, x => true,
				x => new Tuple<string, bool>(x.Stream.ToString(), true), PTableVersions.IndexV4, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault,
	...
	public class when_merging_to_ptable_v4_with_deleted_entries_from_v1 : SpecificationWithDirectoryPerTestFixture {
		...
		public override void TestFixtureSetUp() {
			...
			_newtable = PTable.MergeTo(_tables, _newtableFile, (streamId, hash) => hash << 32 | hasher.Hash(streamId),
				...
				PTableVersions.IndexV4, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault, skipIndexVerify: _skipIndexVerify);
		}
