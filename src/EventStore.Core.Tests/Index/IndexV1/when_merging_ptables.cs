...
namespace EventStore.Core.Tests.Index.IndexV1 {
	...
	public class when_merging_ptables : SpecificationWithDirectoryPerTestFixture {
		...
		public override void TestFixtureSetUp() {
			...
			_tables.Add(PTable.FromMemtable(table, GetTempFilePath(), ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault));
			...
			_newtable = PTable.MergeTo(_tables, GetTempFilePath(), (streamId, hash) => hash + 1, x => true,
				x => new Tuple<string, bool>(x.Stream.ToString(), true), PTableVersions.IndexV1, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault,
	...
	public class when_merging_ptables_to_64bit : SpecificationWithDirectoryPerTestFixture {
		...
		public override void TestFixtureSetUp() {
			...
			_tables.Add(PTable.FromMemtable(table, GetTempFilePath(), ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault));
			_newtable = PTable.MergeTo(_tables, GetTempFilePath(), (streamId, hash) => hash + 1, x => true,
				x => new Tuple<string, bool>(x.Stream.ToString(), true), PTableVersions.IndexV3, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault,
				skipIndexVerify: _skipIndexVerify);
		}
	...
	public class when_merging_2_32bit_ptables_and_1_64bit_ptable_to_64bit : SpecificationWithDirectoryPerTestFixture {
		...
		public override void TestFixtureSetUp() {
			...
			_tables.Add(PTable.FromMemtable(table, GetTempFilePath(), ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault));
			_newtable = PTable.MergeTo(_tables, GetTempFilePath(), (streamId, hash) => hash + 1, x => true,
				x => new Tuple<string, bool>(x.Stream.ToString(), true), PTableVersions.IndexV2, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault,
				skipIndexVerify: _skipIndexVerify);
		}
	...
	public class
		...
		public override void TestFixtureSetUp() {
			...
			_newtable = PTable.MergeTo(_tables, GetTempFilePath(),
				...
				x => new Tuple<string, bool>(x.Stream.ToString(), x.Position % 2 == 0), PTableVersions.IndexV2, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault,
				skipIndexVerify: _skipIndexVerify);
		}
