...
namespace EventStore.Core.Tests.Index.IndexV1 {
	...
	public class adding_item_to_empty_index_map : SpecificationWithDirectoryPerTestFixture {
		...
		public override void TestFixtureSetUp() {
			...
			memtable.Add(0, 1, 0);
			var table = PTable.FromMemtable(memtable, _tablename, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault, skipIndexVerify: _skipIndexVerify);
