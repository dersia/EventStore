...
namespace EventStore.Core.Tests.Index.IndexV1 {
	public class corrupt_index_should : SpecificationWithDirectoryPerTestFixture {
		...
		private string ConstructPTable(byte version) {
			...
			var pTable = PTable.FromMemtable(memTable, pTableFilename, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault, depth);
			pTable.Dispose();
		...
		public void throw_exception_if_index_entries_not_multiple_of_index_entry_size(byte version,
			...
			Assert.Throws<CorruptIndexException>(() => PTable.FromFile(ptableFileName, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault, depth, skipIndexVerify));
		}
		...
		public void throw_exception_if_index_entries_not_descending_during_ptable_get_range(byte version,
			...
			PTable pTable = PTable.FromFile(ptableFileName, ESConsts.PTableInitialReaderCount, TFChunkHelper.PTableMaxReaderCountDefault, 1, skipIndexVerify);
